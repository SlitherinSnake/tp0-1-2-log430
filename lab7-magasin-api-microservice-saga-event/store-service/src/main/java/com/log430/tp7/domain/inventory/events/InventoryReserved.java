 ...
 * 
 * NOTE: This is a copy of the InventoryReserved event for cross-service consumption.
 * In a real microservices architecture, this would ideally be in a shared event library.
 */
