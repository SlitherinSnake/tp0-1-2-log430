...
public class RetourProduit {
    ...
    @ManyToOne
    // Ceci précise que dans la table retourProduit, il y a une colonne retour_id
    // pour identifier le retour.
    @JoinColumn(name = "retour_id")
    private Retour retour;

    // Plusieurs retour de produit peuvent être effectués dans un retour
    @ManyToOne
    // Ceci précise que dans la table retourProduit, il y a une colonne produit_id
