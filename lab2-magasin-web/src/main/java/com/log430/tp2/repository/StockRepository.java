...
import com.log430.tp2.model.Stock;
...
public interface StockRepository extends JpaRepository<Stock, Integer> {
    ...
    List<Stock> findByMagasin(@Param("magasinId") int magasinId);
    ...
    List<Stock> findByProduit(@Param("produitId") int produitId);
    ...
    List<Stock> findDemandesDuJour(@Param("produitId") int produitId, @Param("magasinId") int magasinId);
