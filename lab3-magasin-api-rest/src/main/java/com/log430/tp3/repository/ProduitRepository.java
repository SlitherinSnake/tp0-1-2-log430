...
public interface ProduitRepository extends JpaRepository<Produit, Integer> {
    ...
    // Recherche tp3 produits dont la catégorie contient une chaîne de caractères
    List<Produit> findByCategorieContainingIgnoreCase(String categorie);

    // Recherche tp3 produits dont le nom et la catégorie contiennent une chaîne de
    // caractères
